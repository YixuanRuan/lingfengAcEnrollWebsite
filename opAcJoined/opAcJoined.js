...
$(document).ready(function(){
	$.get("../findAc/joinAc/getAcDetail.php?eventId="+eventId,function(data){
		var x;
	...
	$("#cancelAcJoinBtn").click(function(){
		var phone=localStorage.getItem("phone");
		$.get("cancelSomeoneAc.php?phone="+phone+"&eventId="+$('#eventId span').text());
